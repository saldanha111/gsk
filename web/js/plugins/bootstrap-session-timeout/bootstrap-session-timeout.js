...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        var defaults = {
            ...
            expired: false // Docxpresso variable
        };
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            $('body').append('<div class="modal fade" id="session-timeout-dialog" data-backdrop="static"> \
            ...
            $('#session-timeout-dialog-logout').on('click', function() {
                //modified by Docxpresso
                //window.location = opt.logoutUrl;
                $('#targetData').val("exit");
                openVersionModal('Exit');
            });
        ...
        function startSessionTimer() {
            ...
            timer = setTimeout(function() {
                ...
                if (typeof opt.onWarn !== 'function' && !opt.expired) {
