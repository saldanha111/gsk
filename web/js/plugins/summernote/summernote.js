...
(function (factory) {
  ...
  var Renderer = function () {
    ...
    var tplButton = function (label, options) {
      ...
      var ariaLabel = options.value;//added for accessibility
      ...
      return (dropdown ? '<div class="btn-group' +
               ...
               '<button type="button"' +
                 ...
                 (ariaLabel ? ' aria-label=\'' + value + '\'' : ' aria-label=\'' + event + '\'') +
                 (hide ? ' data-hide=\'' + hide + '\'' : '') +
                 ' tabindex="-1">' +
                 label +
    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        var randNum = Math.floor(Math.random() * 123456789);//to avoid repetition of ids
        var body = '<div class="form-group row-fluid note-group-select-from-files">' +
                     '<label for="fileURL_' + randNum + '">' + lang.image.selectFromFiles + '</label>' +
                     '<input id="fileURL_' + randNum + '" class="note-image-input" type="file" name="files" accept="image/*" multiple="multiple" />' +
                     imageLimitation +
                   '</div>' +
                   '<div class="form-group row-fluid">' +
                     '<label for="imageURL_' + randNum + '">' + lang.image.url + '</label>' +
                     '<input id="imageURL_' + randNum + '" class="note-image-url form-control span12" type="text" />' +
                   '</div>';
      ...
      link: function (lang, options) {
        ...
        var body = '<div class="form-group row-fluid">' +
                     '<label for="linkURL_' + randNum + '">' + lang.link.textToDisplay + '</label>' +
                     '<input id="linkURL_' + randNum + '" class="note-link-text form-control span12" type="text" />' +
                   '</div>' +
                   '<div class="form-group row-fluid">' +
                     '<label for="linkURL2_' + randNum + '">' + lang.link.url + '</label>' +
                     '<input id="linkURL2_' + randNum + '" class="note-link-url form-control span12" type="text" value="http://" />' +
                   '</div>' +
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      //031. create codable
      $('<textarea class="note-codable" aria-label="text"></textarea>').prependTo($editor);
