 ...
 * @ORM\Entity(repositoryClass="Nononsense\HomeBundle\Entity\RevisionRepository")
...
class Revision
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\Nononsense\HomeBundle\Entity\InstanciasSteps", inversedBy="Revisions")
