    ...
    public function search($type,$filters)
    {
        ...
        switch($type){
            case "list":
                ...
                $list->addSelect("CASE WHEN ((SELECT COUNT(elac.step_id) FROM Nononsense\HomeBundle\Entity\FirmasStep elac WHERE elac.userEntiy=:el_userc AND elac.step_id=s.id AND elac.elaboracion=0 AND elac.accion NOT LIKE 'Petición de reconciliación%')>0) THEN 0 ELSE 1 AS cumpliment");
